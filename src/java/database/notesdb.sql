...
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('somethrowawayforschool+ted@gmail.com', true, 'Ted','Something', 'password', 2);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('somethrowawayforschool+fred@gmail.com', true, 'Fred','Something', 'password', 2);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('somethrowawayforschool+shaggy@gmail.com', true, 'Shaggy','Something', 'password', 2);
INSERT INTO `user` (`email`,`active`,`first_name`,`last_name`,`password`,`role`)
	VALUES ('somethrowawayforschool+scooby@gmail.com', true, 'Scooby','Something', 'password', 2);
